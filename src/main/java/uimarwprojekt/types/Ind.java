 ...
 * @generated */
public class Ind extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Ind.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Ind() {/* intentionally empty block */}
   ...
   */
  public Ind(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Ind(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
