...
/** 
 * Updated by JCasGen Wed Nov 25 16:46:59 CET 2015
 ...
 * @generated */
public class Dir extends Annotation {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected Dir() {/* intentionally empty block */}
  ...
  */  
  public Dir(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
