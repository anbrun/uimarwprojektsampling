 ...
 * @generated */
public class Fi extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Fi.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Fi() {/* intentionally empty block */}
   ...
   */
  public Fi(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Fi(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
