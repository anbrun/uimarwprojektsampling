 ...
 * @generated */
public class Rep extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Rep.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Rep() {/* intentionally empty block */}
   ...
   */
  public Rep(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Rep(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
