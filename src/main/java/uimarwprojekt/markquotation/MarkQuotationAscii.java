...
public class MarkQuotationAscii extends JCasAnnotator_ImplBase {
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		...
		while (tokiter.hasNext()) {
			...
			if (tok.getCoveredText().equals(MarkQuotationAscii.openingQuot)) {
				quotStart = tok;
				if (debug) {
				...
				if (tok.getCoveredText().equals(MarkQuotationAscii.closingQuot)) {
					if (debug) {
